...
function createWindow() {
  mainWindow = new BrowserWindow({width: 1000, height: 800, title: "Boilerplate", icon: path.join(__dirname, '../src/assets/icons/favicon.ico'), webPreferences: { nodeIntegration: true, webSecurity: false}});
